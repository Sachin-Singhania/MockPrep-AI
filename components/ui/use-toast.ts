...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "bg-transparent hover:bg-accent text-accent-foreground hover:text-accent-foreground focus:ring-accent",
...
type ToasterProps = {
  /**
   * The duration in milliseconds that the toast will be open.
   * @default 5000
   */
  duration?: number
}

export { useToast, ToastViewport, type Toast, ToastTitle, ToastDescription, ToastClose, ToastAction }
